...
public record ReviewResponse(Long id, String profileSlug, String profileName, String reviewerName, String submittedByEmail, String title, String comment, int rating, LocalDate reviewDate, int displayOrder, boolean published) {
