    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/health", "/api/v1/contacts/**", "/actuator/health/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/internal/maintenance/**").permitAll()
                        ...
                        .requestMatchers("/api/v1/auth/me/**", "/api/v1/auth/me", "/api/v1/favorites/**", "/api/v1/bookings/**").authenticated()
