...
| --- | --- | --- |
| `main` | `e2bb91cd38b381ec951cae0a6fadf9f4a1055904` | Production branch do Cloudflare Pages após hotfix mobile lightbox/branding icons |
| `dev` | `cc53ae072463651a517fea7f76e08fa598ef393d` | Branch de integração após PR #61 |
...
- o hotfix do MediaLightbox iOS/iPadOS e refresh completo dos favicons/icons foi promovido por PR #61 -> `dev` e PR #62 -> `main`; produção frontend atual `e2bb91cd38b381ec951cae0a6fadf9f4a1055904`, validada em iPhone;
...
| Frontend production SHA | `e2bb91cd38b381ec951cae0a6fadf9f4a1055904` |
